...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Volunteer | Global Sprint</title>
        <!-- Web Fonts -->
...
<div class="js__parallax-window" style="background: url(img/wp/23.png) 50% 0 repeat fixed;" >
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
                    <p class="text-uppercase g-font-size-20--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs"><br/><br/><br/>Global Sprint</p>
                    <h2 class="g-font-size-32--xs g-color--white g-font-size-36--md">Volunteer Registration</h2>
                </div>
                <form>
                    ...
                    <div class="row">
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                ...
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://wiki.mozilla.org/Kerala">Wiki</a></li>
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="http://blog.mozillakerala.co">Blog</a></li>
                        ...
                        <div class="col-sm-2 g-margin-b-20--xs g-margin-b-0--md">
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-0--xs">
                                ...
                                <li><a class="g-font-size-15--xs g-color--white-opacity" href="https://plus.google.com/communities/114787248813145966099">Google+</a></li>
                            </ul>
                        </div>
