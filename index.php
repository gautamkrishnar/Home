...
<head>
    ...
    <title>mozilla kerala | Home</title>
    <!-- Web Fonts -->
...
<div class="s-swiper js__swiper-one-item">
    ...
    <div class="swiper-wrapper">
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/wp/22.jpg');">
        ...
        <div class="g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('img/wp/4.jpg');">
            <div class="container g-text-center--xs g-ver-center--xs">
                <div class="g-margin-b-30--xs">
                    <!-- <div class="g-margin-b-30--xs">
                        <h2 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">"Together we build <br>the web"</h2>
                    </div> -->
                    <!--<a class="js__popup__youtube" href="https://www.youtube.com/watch?v=lcFYdgZKZxY" title="Intro Video">
                        <i class="s-icon s-icon--lg s-icon--white-bg g-radius--circle ti-control-play"></i>
                    </a>-->
...
<div class="js__parallax-window" style="background: url(img/bkg/4.jpg) 50% 0 no-repeat fixed;">
    ...
    <div class="parallax" style="background: url(img/wp/11.png) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white" id="demo"></h2>
                <p class="text-uppercase g-color--white g-letter-spacing--3 g-margin-b-0--xs">Days to go. Stay tuned!</p>
            </div>

            <script>
                // Set the date we're counting down to
                var countDownDate = new Date("may 10, 2018 07:00:00").getTime();
        ...
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            ...
            <form>
                <div class="row g-margin-b-40--xs">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control s-form-v2__input g-radius--10 g-padding-y-20--xs" rows="8" name="txt_message" placeholder="* Your message"></textarea>
                    </div>
                </div>
